# PyQtを使ったポモドーロタイマー＆ToDoアプリの実装例
# 注意: このコードを使用するには、PyQt5をインストールする必要があります
#pip install PyQt5
...
class PomodoroTodoApp(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("ポモドーロ & ToDo アプリ")
    ...
    def setup_todo_ui(self):
        ...
        todo_title.setFont(QFont("Arial", 16, QFont.Bold))
