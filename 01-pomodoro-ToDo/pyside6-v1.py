...
class TodoItemWidget(QWidget):
    def __init__(self, parent=None, task_data=None, main_window=None, index=0):
        ...
        self.check_label.setStyleSheet("color: #000000; min-width: 20px; font-size: 16px; font-weight: bold; background-color: transparent;")
        ...
        self.number_label.setMinimumWidth(15)
        layout.addWidget(self.number_label)
        
        self.start_combo = QComboBox()
        self.start_combo.setObjectName("time_combo")
        self.start_combo.setMinimumWidth(60)
        ...
        self.end_combo.setMinimumWidth(60)
        for hour in range(7, 21):
        ...
        self.add_button.setFixedSize(16, 16)
...
class WindowsClockStylePomodoro(QMainWindow):
    ...
    def setup_timer_ui(self):
        ...
        self.date_time_label.setFont(QFont("Segoe UI", 12))
        self.date_time_label.setMinimumHeight(24)
    ...
    def reset_timer(self):
        self.timer.stop()
        self.time_left = self.work_time_combo.currentData() if not self.is_break else self.break_time_combo.currentData() * 60
    ...
    def update_timer(self):
        ...
        if self.time_left <= 0:
            ...
            if not self.is_break:
                QMessageBox.information(self, "作業終了", "作業時間が終了しました！一度休憩しましょう。")
                self.is_break = True
